...
pages = []
for i in range(5):
    pages.append(inspectify.Frame(root, bg="#000080"))
...
def basicPageSetup(pageNo):
    ...
    back_img = inspectify.PhotoImage(file= r"/Users/samikshajain/Downloads/INSPECTIFY/img/backk.png")
    back_button = inspectify.Button(pages[pageNo], image=back_img, bg="#000080", bd=0, highlightthickness=0,
           activebackground="#000080", command=goBack)
    back_button.image = back_img
    back_button.place(x=10, y=10)

    heading = inspectify.Label(pages[pageNo], fg="white", bg="#000080", font="Arial 20 bold", pady=10)
    heading.pack()

    content = inspectify.Frame(pages[pageNo], bg="#000080", pady=20)
    content.pack(expand="true", fill="both")

    left_frame = inspectify.Frame(content, bg="#000080")
    left_frame.grid(row=0, column=0, sticky="nsew")

    right_frame = inspectify.LabelFrame(content, text="Detected Criminals", bg="#000080", font="Arial 20 bold", bd=4,
...
def getPage1():
    ...
    basicPageSetup(1)
    heading.configure(text="Register Criminal", bg="#000080")
    right_frame.configure(text="Enter Details", fg="white", bg="#000080")

    btn_grid = inspectify.Frame(left_frame, bg="#000080")
    btn_grid.pack()

    inspectify.Button(btn_grid, text="Select Images", command=lambda: selectMultiImage(opt_menu, menu_var), font="Arial 20 ", bg="#00008B",
           fg="#00008B", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
           activeforeground="white").grid(row=0, column=0, padx=25, pady=25)


    # Creating Scrollable Frame
    canvas = inspectify.Canvas(right_frame, bg="#000080", highlightthickness=0)
    canvas.pack(side="left", fill="both", expand="true", padx=30)
    scrollbar = inspectify.Scrollbar(right_frame, command=canvas.yview, width=20, troughcolor="#000080", bd=0,
                          activebackground="#000080", bg="#00008B", relief="raised")
    scrollbar.pack(side="left", fill="y")

    scroll_frame = inspectify.Frame(canvas, bg="#000080", pady=20)
    ...
    inspectify.Label(scroll_frame, text="* Required Fields", bg="#000080", fg="yellow", font="Arial 13 bold").pack()
    # Adding Input Fields
    ...
    for i, field in enumerate(input_fields):
        print()
        row = inspectify.Frame(scroll_frame, bg="#000080")
        row.pack(side="top", fill="x", pady=15)

        label = inspectify.Text(row, width=20, height=1, bg="#000080", fg="#ffffff", font="Arial 13", highlightthickness=0, bd=0)
        ...
        if(i != ip_len-1):
            ...
            opt_menu.configure(font="Arial 13", bg="#00008B", fg="white", bd=0, highlightthickness=0, activebackground="#000080")
            menu = opt_menu.nametowidget(opt_menu.menuname)
            menu.configure(font="Arial 13", bg="white", activebackground="#000080", bd=0)

    # print(entries)

    inspectify.Button(scroll_frame, text="Register", command=lambda: register(entries, required, menu_var), font="Arial 20",
           bg="#00008B", fg="#00008B", pady=10, padx=30, bd=0, highlightthickness=0, activebackground="#000080",
...
def getPage2():
    ...
    inspectify.Button(btn_grid, text="Choose Image", command=selectImage, font="Arial 20 ", padx=20, bg="#000080",
            fg="#000080", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
            activeforeground="#000080").grid(row=0, column=0, padx=25, pady=25)
    inspectify.Button(btn_grid, text="Identify", command=startRecognition, font="Arial 20 ", padx=20, bg="#00008B",
           fg="#000080", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
           activeforeground="#000080").grid(row=0, column=1, padx=25, pady=25)
...
def getPage4(path):
    ...
    btn_grid = inspectify.Frame(right_frame, bg="#000080")
    btn_grid.pack()
...
def getPage3():
    ...
    inspectify.Button(btn_grid, text="Select Video", command=selectvideo, font="Arial 20 ", padx=20, bg="#00008B",
                fg="#00008B", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
                activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
    
    

    # inspectify.Button(btn_grid, text="Recognize", command=getPage3(), font="Arial 15 bold", padx=20, bg="#00008B",
    #        fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
...
#     inspectify.Button(btn_grid, text="Select video", command=selectvideo, font="Arial 15 bold", padx=20, bg="#00008B",
#             fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
#             activeforeground="white").grid(row=0, column=0, padx=25, pady=25)
#     inspectify.Button(btn_grid, text="Recognize", command=startRecognition, font="Arial 15 bold", padx=20, bg="#00008B",
#            fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#000080",
#            activeforeground="white").grid(row=0, column=1, padx=25, pady=25)
...
######################################## Home Page ####################################
inspectify.Label(pages[0], text="INSPECTIFY", fg="white", bg="#000080",
      font="Arial 50 bold", pady=30).pack()


logo = inspectify.PhotoImage(file = r"/Users/samikshajain/Downloads/INSPECTIFY/img/think.png")
inspectify.Label(pages[0], image=logo, bg="#000080").pack(side='left')

btn_frame = inspectify.Frame(pages[0], bg="#000080", pady=130)
btn_frame.pack()

##inspectify.Button(btn_frame, text="", command=selectvideo1)
...
for btn in btn_frame.winfo_children():
	btn.configure(font="Arial 20", width=17, bg="#000080", fg="#000080", pady=15, bd=0, highlightthickness=0, activebackground="#000080", activeforeground="#000080")
	btn.pack(pady=30)
